...
# Ensure window size for desktop testing (can be removed on device)
Window.size = (360, 640)
...
class YouTubeDownloader(BoxLayout):
    def __init__(self, **kwargs):
        ...
        self.download_dir = primary_external_storage_path() + "/Download"
        try:
...
class YTApp(App):
    def build(self):
        # Request storage permissions at runtime (Android 6+)
        request_permissions([
